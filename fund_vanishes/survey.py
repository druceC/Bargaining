...
class Player(BasePlayer):
    ...
    atq_1 = models.IntegerField(
        label="In a lake, there is a patch of lily pads. Every day, the patch doubles in size. If it takes 48 days for thye patch to cover the entire lake, how long would it take for the patch to cover half of the lake? (only numbers, no words)?",
        max=10000000,
        min=-10000000,
    )
    ...
    stud = models.StringField(
        choices=[[1, 'Yes'], [2, 'No']],
        label="Are you a currently a student at U Vienna or another higher education institution?",
        widget=widgets.RadioSelect,
    )
    ...
    degree = models.StringField(
        choices=[[1,"Primary school"],[2,"High school"],[3,"Vocational education"],[3,"Short higher education (less than 3 years)"],
        [4,"Bachelor's degree or similar"],[5,"Master's degree, similar or higher"]],
    ...
    volunt_hrs = models.StringField(
        choices=[[1,"1 to 4 hours"],[2,"5 to 9 hours"],[3,"10 to 14 hours"],[4,"15 or more hours"],[5,"Don't know"]],
        label='Approximately how many hours a week do you spend doing working at your student job?',
        widget=widgets.RadioSelect,
    )
    ...
    spbrn = models.StringField(
        choices=[[1, 'Yes'], [2, 'No'], [3, "Don't know"]],
        label="Were you born in Austria?",
        widget=widgets.RadioSelect,
    )
    spcit = models.StringField(
        choices=[[1, 'Yes'], [2, 'No'], [3, "Don't know"]],
        label="Are you an Austrian citizen?",
        widget=widgets.RadioSelect,
    )
    ...
    rel_spec = models.StringField(
        choices=[[1,"Christianity - Catholicism"], [2,"Christianity - Other denomination"],
        [3,"Islam - All denominations"],[4,"Buddhism"],[5,"Hinduism"],[6,"Judaism"],[7,"Other"],[8,"Don't know"]],
    ...
    mth_spbrn = models.StringField(
        choices=[[1, 'Yes'], [2, 'No'], [3, "Don't know"]],
        label="Was your mother born in Austria?",
        widget=widgets.RadioSelect,
    )
    fth_spbrn = models.StringField(
        choices=[[1, 'Yes'], [2, 'No'], [3, "Don't know"]],
        label="Was your father born in Austria?",
        widget=widgets.RadioSelect,
    )
    ...
    mth_spcit = models.StringField(
        label="Is your mother an Austrian citizen?",
    )
    fth_spcit = models.StringField(
        label="Is your father an Austrian citizen?",
    )
...
class Part3a(Page):
    form_model = 'player'
    form_fields = ['stud_degree','stud_job','finc_supp','volunt']
...
class Part4a(Page):
    form_model = 'player'
    form_fields = ['stud_job_hrs','volunt_hrs']
